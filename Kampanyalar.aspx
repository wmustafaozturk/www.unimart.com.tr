<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Kampanyalar.aspx.vb" Inherits="UniMart.Kampanyalar" %>
...
<head>
  ...
  <title>Deniz Ticaret kampanyalar</title>
  ...
  ======================================================= -->
    <!--sayfa ilk açıldığında popup açılır-->
   ...
   <form id="form1" runat="server">
    <div id="wrapper">
                ...
                <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                         ...
                         <li class="dropdown">
                            <a href="#" class="toggle" data-toggle=""><span class="badge custom-badge red pull-right"></span>KAMPANYALAR <b class=""></b></a>
                        </li>
                        <li class="dropdown">
        ...
        <!-- Section: intro -->
            ...
            <!-- Popup Modal  sayfa açıldığında popup açılır *************************
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body" style="background-color:#f49719">
                    <p>MONTAJ,BALANS VE ÖZEL NİTROJEN HAVA ÜCRESİZDİR.!!!</p>
                  </div>
                    ...
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="wow fadeInDown" data-wow-delay="0.1s">
                            <div class="section-heading text-center">
                                <h2 class="h-bold">KAMPANYALAR</h2>
                                <!-- Popup Modal  sayfa açıldığında popup açılır *************************-->
