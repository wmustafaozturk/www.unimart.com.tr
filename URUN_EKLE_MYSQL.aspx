<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="URUN_EKLE_MYSQL.aspx.vb" Inherits="UniMart.URUN_EKLE_MYSQL" %>
...
<body>
    <form id="form1" runat="server">
         ...
         <div class="container">
          ...
          <li><a class="codrops-icon" id="Btn_Ara" runat="server" >Ürün Ara</a></li>
          <li><a class="codrops-icon" id="Btn_Urun_Ekle" runat="server" >ÜRÜN EKLE</a></li>                 
          <li><a class="codrops-icon" id="Btn_iptal" runat="server" href="URUN_EKLE_MYSQL.aspx" >İŞLEM İPTAL</a></li>
                 ...
                 <li><a class="codrops-icon " href="URUN_EKLE_MYSQL.aspx"><img src="images/home.png" /></a></li>
                 ...
                 <tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <asp:ListItem Text="Jant" Value="Jant"></asp:ListItem> 
                        <asp:ListItem Text="Yigit_Akü" Value="Yigit_Akü"></asp:ListItem>  
                     ...
                     <tr>
                        ...
                        <asp:ListItem Text="Kislik" Value="Kislik"></asp:ListItem>  
